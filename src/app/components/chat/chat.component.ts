...
export class ChatComponent implements OnInit, OnDestroy {
  ...
  setMessageConversation() {
    ...
    this.stompConvSub = this.stomp.subscribe(
      ...
      (payload: any) => {
        ...
        //   let msg: ConversationResponse = res.data;
        //   this.userConversations.unshift(msg);
        // }
      }
    );
    // Notify that I'm subscribed to get initial data
    // this.stomp.send('conv', this.currentUser.id);
  }
  ...
  onUserSelected(
    ...
    // receiverPageName: string
  ) {
    this.selectedConversationReceiverId = receiverId;
    this.selectedConversationReceiverName = receiverName;
    // this.selectedConversationReceiverImage = receiverImage;
    // this.selectedConversationReceiverLastMessage = receiverLastMessage;
    // this.selectedConversationReceiverPageName = receiverPageName;
    this.userService
